...
export default class PersonaCustomerGridService {
    constructor(component, repoCustomers, repoConditionCustomers, context) {
        this.component = component;
        this.repoCustomers = repoCustomers;
        this.repoConditionCustomers = repoConditionCustomers;
    ...
    getColumns() {
        return [{
            property: 'fullName',
            dataIndex: 'fullName',
            label: this.component.$tc('custom-bonus-system.detail.main.preconditions.persona.customers.grid.headerName'),
            allowResize: false
        }, {
            property: 'customerNumber',
            dataIndex: 'customerNumber',
            label: this.component.$tc('custom-bonus-system.detail.main.preconditions.persona.customers.grid.headerCustomerNumber'),
            allowResize: false
        }];
    }
    ...
    async reloadCustomers() {
        ...
        await this.repoConditionCustomers.search(criteria, this.context).then((customers) => {
